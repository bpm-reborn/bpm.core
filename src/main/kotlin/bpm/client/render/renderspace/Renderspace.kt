...
class Renderspace(dockName: String) : Dockable(dockName, null) {
    ...
    override fun render(gfx: GuiGraphics, graphics: CanvasGraphics) {
        ...
        ImGui.setNextWindowPos(0f, 40f)
        ImGui.setNextWindowSize(ImGui.getIO().displaySize.x, ImGui.getIO().displaySize.y - 40f)
